...
const PrivacyPolicy = () => {
  ...
  return (
    <div>
      <div className="container my-5 privacy_policy">
        <div className="row">
          <div className="col-md-12">
            <h2 className="skyblue work_sans_bold mb-4">Privacy Policy</h2>
            ...
            <h2 className="skyblue work_sans_bold mt-5 mb-4">
              Interpretation and Definitions
            </h2>
            <h6 className="work_sans_bold font-28">Interpretation</h6>
            <p className="font-18 wor_sans mt-3">
            ...
            <h6 className="work_sans_bold font-28">Definitions</h6>
            <p className="font-18 wor_sans mt-3">
            ...
            <div className="d-flex" style={{ gap: "30px" }}>
              ...
              <p className="font-18 wor_sans mt-3 ml-3">
                ...
                "Our" in this Agreement) refers to Athletes Connect LLC,
                Wyoming.
              </p>
            </div>
            <div className="d-flex" style={{ gap: "30px" }}>
            ...
            <div className="d-flex" style={{ gap: "30px" }}>
              <img src="img/arrow-right.svg" width="7px" alt="" />
              <p className="font-18 wor_sans mt-3 ml-3">
                Website refers to Athletes Connected, accessible from
                www.athleteconnect.com
              </p>
            </div>
            <div className="d-flex" style={{ gap: "30px" }}>
              <img src="img/arrow-right.svg" width="7px" alt="" />
            ...
            <h2 className="skyblue work_sans_bold my-4">
              Collecting and Using Your Personal Data
            </h2>
            <h2 className="font-28 skyblue work_sans_bold mb-4">
              Types of Data Collected
            </h2>
            <h2 className="font-28 work_sans_bold mb-4">Personal Data</h2>
            <p className="font-18 wor_sans mt-3">
            ...
            <div className="d-flex" style={{ gap: "30px" }}>
              <img src="img/arrow-right.svg" width="7px" alt="" />
              <p className="font-18 wor_sans mt-3 ml-3">Email address</p>
            </div>
            <div className="d-flex" style={{ gap: "30px" }}>
              <img src="img/arrow-right.svg" width="7px" alt="" />
              <p className="font-18 wor_sans mt-3 ml-3">
            ...
            <div className="d-flex" style={{ gap: "30px" }}>
              <img src="img/arrow-right.svg" width="7px" alt="" />
              <p className="font-18 wor_sans mt-3 ml-3">Phone number</p>
            </div>
            <div className="d-flex" style={{ gap: "30px" }}>
              <img src="img/arrow-right.svg" width="7px" alt="" />
              <p className="font-18 wor_sans mt-3 ml-3">Usage Data</p>
            </div>
            <h2 className="font-28 work_sans_bold mb-4 mt-3">Usage Data</h2>
            <p className="font-18 wor_sans mt-3">
            ...
            <h2 className="font-28 work_sans_bold mb-4">
            ...
            <p className="font-18 wor_sans mt-3">
              ...
              Your web browser. Learn more about cookies: Cookies by
              PrivacyPolicies Generator. We use both Session and Persistent
              Cookies for the purposes set out below:
            </p>
            <div className="d-flex" style={{ gap: "30px" }}>
              <img src="img/arrow-right.svg" width="7px" alt="" />
              <p className="font-18 wor_sans mt-3 ml-3">
                <span className="font-18 wor_sans_bold mt-3">
            ...
            <h2 className="font-28 work_sans_bold mb-4">Law enforcement</h2>
            <p className="font-18 wor_sans mt-3">
            ...
            <h2 className="skyblue work_sans_bold my-4">Children's Privacy</h2>
            <p className="font-18 wor_sans mt-3">
            ...
            <h2 className="skyblue work_sans_bold my-4">Contact Us</h2>
            <p className="font-18 wor_sans mt-3">
            ...
            <div className="d-flex" style={{ gap: "30px" }}>
              <img src="img/arrow-right.svg" width="7px" alt="" />
              <p className="font-18 wor_sans mt-3 ml-3">
                By email: athconnected@gmail.com
              </p>
            </div>
          </div>
        </div>
